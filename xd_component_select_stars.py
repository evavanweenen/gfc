...
n = 0
gfc.gplot.moving_group(t["ra"], t["dec"], t["l"], t["b"], t["U"], t["V"], t["W"], bins = 100, saveto = "all_mg.png") 
t_subs = [t[Ls[:,n] > -args.threshold] for n in range(len(means_xd))]
for n, t_ in enumerate(t_subs):
    if args.verbose:
        print "{n:02d}: {l}".format(n=n, l=len(t_))
    gfc.gplot.moving_group(t_["ra"], t_["dec"], t_["l"], t_["b"], t_["U"], t_["V"], t_["W"], a = amps_xd[n], m = means_xd[n], c = covs_xd[n], bins = 100, saveto = "{0:02d}_mg.png".format(n+1)) 
