...
def write_table_without_arrays(t, saveto, format="ascii.fixed_width", exclude_cols=[], *args, **kwargs):
    new_t = t.copy()
...
def write_table_with_separate_arrays(t, saveto_folder, format="ascii.fixed_width", exclude_cols=[], *args, **kwargs):
